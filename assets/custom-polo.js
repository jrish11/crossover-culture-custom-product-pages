(() => {
  ...
  const DEFAULT_COLORS = {
    Base: { hex: '#111111', name: 'Black', apply: 'Applies to the shirt body and collar.' },
  ...
  const initializeSection = (section) => {
    ...
    const submittingLabel = addToCartButton?.dataset.submittingLabel || 'Adding Polo Order...';
  ...
  document.querySelectorAll('.custom-polo-section').forEach(initializeSection);
})();
